...
def morethings():
    mver=1.7
    global rc,pin,used,cps,qwe,loger,doc,ver,fn,ast,rozlist,service,rmb,freecjtimes
...
第4个成就一一新的世界：需要打开隐藏菜单（注意：本成要最先完成，若先完成其他成就，将无法再获得此成就）''' )
        ...
        if freecjtimes%2:
            ...
            pass
    #     freecjtimes=freecjtimes+1
    #     if freecjtimes==1:
    #         t_firstopen=t[4]
    #     if freecjtimes==2:
    #         t_secondopen=t[4]
    #         freecjtimes = freecjtimes - 2
    #         de = t_secondopen-t_firstopen
    #         if de<2:
    #             print(f"请在{2-de}分钟后再来抽奖")
    #             continue
    ...
    (更多物品敬请期待)''')
        ...
        if 'cmd-m' in service:
            ...
            if p < 26:  # 25
                ...
                print("               ")
                p = p - p
#version=15.3,line in 2213 CrosWuft,2022,7,10,s1 TM
